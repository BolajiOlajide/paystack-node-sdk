...
export const isNonErrorResponse = (statusCode: number): boolean => {
  return statusCode >= StatusCodes.CONTINUE && statusCode < StatusCodes.BAD_REQUEST;
};

// Reference: https://sourcegraph.com/github.com/prettymuchbryce/http-status-codes@master/-/blob/src/status-codes.ts
