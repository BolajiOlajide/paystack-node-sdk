...
> available [Documentation](https://github.com/BolajiOlajide/paystack-node).

Before you ask a question, it is best to search for
existing [Issues](https://github.com/BolajiOlajide/paystack-node-sdk/issues) that might help you. In case you have found
...
- Open an [Issue](https://github.com/BolajiOlajide/paystack-node-sdk/issues/new).
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment
  components/versions (Make sure that you have read the [documentation](https://github.com/BolajiOlajide/paystack-node).
  If you are looking for support, you might want to check [this section](#i-have-a-question)).
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there
  is not already a bug report existing for your bug or error in
  the [bug tracker](https://github.com/BolajiOlajide/paystack-node-sdk/issues?q=label%3Abug).
...
> tracker, or elsewhere in public. Instead, sensitive bugs must be sent by email to <!-- bolaji@example.com -->.

<!-- You may add a PGP key to allow the messages to be sent encrypted as well. -->

We use GitHub issues to track bugs and errors. If you run into an issue with the project:

- Open an [Issue](https://github.com/BolajiOlajide/paystack-node-sdk/issues/new). (Since we can't be sure at this point
